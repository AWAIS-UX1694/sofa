...
// Modify the path according to your application setup
  ...
  return (
    <m.div className="flex justify-center items-center h-screen">
      <div className="items-center lg:w-2/3 w-full gap-10 px-10 py-8  bg-white rounded-lg flex">
        <div className="w-1/2 hidden md:block lg:block mr-4 items-center " >
          <div className="flex justify-center flex-col items-center mb-8">
            ...
            className='absolute text-6xl font-bold mb-3'>SignUp.</m.h1>
        ...
        <h1 className='py-4 text-4xl font-bold'>Create Account</h1>
